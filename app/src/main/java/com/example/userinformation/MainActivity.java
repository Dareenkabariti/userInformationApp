...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextUserNumber = findViewById(R.id.et_user_number);
        editTextUserAddress = findViewById(R.id.et_user_address);
    ...
    public void saveToFirebase(View v) {
        ...
        if (!(username.isEmpty() && userAddress.isEmpty() && usernumber.isEmpty())) {
